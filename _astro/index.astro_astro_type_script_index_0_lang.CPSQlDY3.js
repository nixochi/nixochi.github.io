...
`;class H{constructor(t,i){this.canvas=t,this.gl=i,this.buffer=null,this.numPoints=0,this.bounds=null,this.camera=null,this.pointSize=1.5,this.programs={},this.activeProgram="mono",this.monoColor=[.502,.941,.753],this.colorFirst=[0,0,1],this.colorLast=[0,1,0],this.lutzN=0,this.lutzW=0,this.lutzD=0,this.lutzC=12,this.lutzNumClasses=0,this.lutzBucketToClass=new Int32Array(256),this.animationId=null,this.visiblePoints=0,this.animating=!1}compileProgram(t,i){const e=this.gl,n=e.createShader(e.VERTEX_SHADER);if(e.shaderSource(n,t),e.compileShader(n),!e.getShaderParameter(n,e.COMPILE_STATUS))throw new Error("Vertex shader error: "+e.getShaderInfoLog(n));const s=e.createShader(e.FRAGMENT_SHADER);if(e.shaderSource(s,i),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS))throw new Error("Fragment shader error: "+e.getShaderInfoLog(s));const a=e.createProgram();if(e.attachShader(a,n),e.attachShader(a,s),e.linkProgram(a),e.deleteShader(n),e.deleteShader(s),!e.getProgramParameter(a,e.LINK_STATUS))throw new Error("Program link error: "+e.getProgramInfoLog(a));return a}init(){const t=this.gl,i=this.compileProgram(N,$);this.programs.mono={program:i,position:t.getAttribLocation(i,"position"),mvp:t.getUniformLocation(i,"mvp"),pointSize:t.getUniformLocation(i,"pointSize"),pointColor:t.getUniformLocation(i,"pointColor")};const e=this.compileProgram(O,W);this.programs.time={program:e,position:t.getAttribLocation(e,"position"),mvp:t.getUniformLocation(e,"mvp"),pointSize:t.getUniformLocation(e,"pointSize"),numPoints:t.getUniformLocation(e,"numPoints"),colorFirst:t.getUniformLocation(e,"colorFirst"),colorLast:t.getUniformLocation(e,"colorLast")};const n=this.compileProgram(j,V);return this.programs.lutz={program:n,position:t.getAttribLocation(n,"position"),mvp:t.getUniformLocation(n,"mvp"),pointSize:t.getUniformLocation(n,"pointSize"),c:t.getUniformLocation(n,"c"),numClasses:t.getUniformLocation(n,"numClasses"),bucketToClass:t.getUniformLocation(n,"bucketToClass")},t.enable(t.BLEND),t.blendFunc(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA),this.camera=new Y(this.canvas),this.camera.onChange=()=>this.draw(),this.resize(),window.addEventListener("resize",()=>this.resize()),this}resize(){this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight,this.gl.viewport(0,0,this.canvas.width,this.canvas.height),this.draw()}setPointBuffer(t,i){this.stopAnimation(),this.buffer=t,this.numPoints=i,this.visiblePoints=i}setBounds(t){this.bounds=t}setPointSize(t){this.pointSize=t}setColorScheme(t){this.programs[t]&&(this.activeProgram=t)}setMonoColor(t){this.monoColor=t}setMonoColorHex(t){this.monoColor=this.hexToRgb(t)}setTimeColors(t,i){this.colorFirst=t,this.colorLast=i}hexToRgb(t){const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return i?[parseInt(i[1],16)/255,parseInt(i[2],16)/255,parseInt(i[3],16)/255]:[1,1,1]}setTimeColorsHex(t,i){this.colorFirst=this.hexToRgb(t),this.colorLast=this.hexToRgb(i)}setLutzParams(t,i,e){this.lutzN=t,this.lutzW=i,this.lutzD=e}setLutzLUT(t){this.lutzC=t.c,this.lutzNumClasses=t.numClasses;for(let i=0;i<t.c&&i<256;i++)this.lutzBucketToClass[i]=t.bucketToClass[i]}stopAnimation(){this.animationId!==null&&(cancelAnimationFrame(this.animationId),this.animationId=null),this.animating=!1}animateIn(t=2e3,i="easeOut"){if(this.stopAnimation(),this.numPoints===0)return;console.log("animateIn called, numPoints:",this.numPoints,"duration:",t),this.animating=!0,this.visiblePoints=0;const e=performance.now(),n=this.numPoints,s={linear:c=>c,easeOut:c=>1-Math.pow(1-c,3),easeInOut:c=>c<.5?4*c*c*c:1-Math.pow(-2*c+2,3)/2},a=s[i]||s.easeOut,d=()=>{if(!this.animating)return;const c=performance.now()-e,r=Math.min(c/t,1),u=a(r);this.visiblePoints=Math.floor(u*n),this.draw(),r<1?this.animationId=requestAnimationFrame(d):(this.visiblePoints=n,this.animating=!1,this.animationId=null)};this.animationId=requestAnimationFrame(d)}zoomToFit(){if(!this.camera||!this.bounds)return;const{minX:t,maxX:i,minY:e,maxY:n}=this.bounds,s=(t+i)/2,a=(e+n)/2,d=i-t||1,c=n-e||1,r=Math.max(d,c)*.6;this.camera.lookAt([s,a],r),this.draw()}draw(){if(!this.gl||this.numPoints===0)return;const t=this.gl,i=this.programs[this.activeProgram];t.viewport(0,0,this.canvas.width,this.canvas.height),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT),t.useProgram(i.program),t.uniformMatrix4fv(i.mvp,!1,this.camera.getMVP()),t.uniform1f(i.pointSize,this.pointSize),this.activeProgram==="mono"&&t.uniform3fv(i.pointColor,this.monoColor),this.activeProgram==="time"&&(t.uniform1i(i.numPoints,this.numPoints),t.uniform3fv(i.colorFirst,this.colorFirst),t.uniform3fv(i.colorLast,this.colorLast)),this.activeProgram==="lutz"&&(t.uniform1i(i.c,this.lutzC),t.uniform1i(i.numClasses,this.lutzNumClasses),t.uniform1iv(i.bucketToClass,this.lutzBucketToClass)),t.bindBuffer(t.ARRAY_BUFFER,this.buffer),t.enableVertexAttribArray(i.position),t.vertexAttribPointer(i.position,2,t.FLOAT,!1,0,0);const e=this.animating?this.visiblePoints:this.numPoints;t.drawArrays(t.POINTS,0,e)}dispose(){this.stopAnimation(),this.camera&&this.camera.dispose(),this.buffer&&this.gl.deleteBuffer(this.buffer);for(const t in this.programs)this.gl.deleteProgram(this.programs[t].program)}}class q{constructor(){this.bucketToClass=null,this.numClasses=0,this.c=12,this._cachedN=null,this._cachedW=null,this._cachedC=null}compute(t,i,e){if(t===this._cachedN&&i===this._cachedW&&e===this._cachedC)return;this.c=e;const n=new Int32Array(e);for(let l=0;l<e;l++)n[l]=l;const s=l=>(n[l]!==l&&(n[l]=s(n[l])),n[l]),a=(l,m)=>{const f=s(l),C=s(m);f!==C&&(n[f]=C)},d=new Array(e).fill(!1),c=new Uint8Array(t);for(let l=0;l<t;l++){if(c[l])continue;let m=l,f=m;const C=new Set;do c[m]=1,m<f&&(f=m),C.add(m%e),m=m*i%t;while(m!==l&&!c[m]);const M=f%e,P=Array.from(C);for(let L=1;L<P.length;L++)a(P[0],P[L]);d[M]=!0}const r=new Map;let u=0;this.bucketToClass=new Int32Array(e);for(let l=0;l<e;l++){const m=s(l);r.has(m)||r.set(m,u++),this.bucketToClass[l]=r.get(m)}this.numClasses=u,this._cachedN=t,this._cachedW=i,this._cachedC=e,console.log(`LutzColorer: c=${e}, numClasses=${this.numClasses}`)}getLUT(){return{bucketToClass:this.bucketToClass,numClasses:this.numClasses,c:this.c}}}const I=document.getElementById("canvas"),A=I.getContext("webgl2",{alpha:!0,antialias:!1,preserveDrawingBuffer:!0,premultipliedAlpha:!1});if(!A)throw new Error("WebGL2 not supported");const x=new X(A);x.init();const h=new H(I,A);h.init();const E=new q;function z(o,t){for(;t!==0;)[o,t]=[t,o%t];return o}function F(o,t){let i=t+1;for(;z(o,i)!==1;)i++;return i}function R(o,t){let i=t-1;for(;i>1&&z(o,i)!==1;)i--;return i>0?i:1}function k(o,t){let i=1;for(let e=1;e<o;e++)if(i=i*t%o,i===1)return e;return o}let p=255255,v=254,_=12,D=!1,S=2e3;function y(o,t){p=o,v=t,window.dispatchEvent(new CustomEvent("gp-values-changed",{detail:{n:o,w:t}})),console.log(`n: ${o.toLocaleString()} | w: ${t} | computing d...`);const i=k(o,t);console.log(`d: ${i.toLocaleString()}`);const e=performance.now(),n=x.run(o,t),s=performance.now();h.setPointBuffer(n.buffer,n.numPoints),h.setBounds(n.bounds),h.setLutzParams(o,t,i),h.activeProgram==="lutz"&&B(),h.zoomToFit(),D&&(console.log("Starting animation, duration:",S),h.animateIn(S));const a=performance.now();A.finish();const d=performance.now();console.log(`compute: ${(s-e).toFixed(2)}ms | draw: ${(a-s).toFixed(2)}ms | gpu sync: ${(d-a).toFixed(2)}ms | total: ${(d-e).toFixed(2)}ms`)}function B(){if(p===0||v===0)return;const o=performance.now();E.compute(p,v,_),h.setLutzLUT(E.getLUT());const t=performance.now();console.log(`Lutz LUT: ${(t-o).toFixed(2)}ms`)}function G(o){_=o,h.activeProgram==="lutz"&&(B(),h.draw())}function K(o){D=o,console.log("Animation enabled:",o)}function Z(o){S=o}function J(){h.animateIn(S)}y(255255,254);window.dispatchEvent(new Event("app-ready"));window.renderPoints=y;window.computer=x;window.renderer=h;window.lutzColorer=E;window.gcd=z;window.nextCoprime=F;window.prevCoprime=R;window.order=k;window.updateLutzColoring=B;window.setLutzC=G;window.setAnimateEnabled=K;window.setAnimationDuration=Z;window.triggerAnimation=J;window.addEventListener("keydown",o=>{if(!(o.target.tagName==="INPUT"||o.target.tagName==="TEXTAREA")){if(o.key==="n"&&p>0&&v>0){const t=F(p,v);window.renderPoints(p,t)}else if(o.key==="p"&&p>0&&v>1){const t=R(p,v);window.renderPoints(p,t)}}});function w(o){return o&&parseInt(o.getAttribute("data-value")||"0")||0}const b=document.getElementById("nInput"),g=document.getElementById("wInput"),Q=document.getElementById("renderBtn"),tt=document.getElementById("prevCoprimeBtn"),et=document.getElementById("nextCoprimeBtn"),it=document.getElementById("pointSizeSlider"),ot=document.getElementById("lutzCSlider"),nt=document.getElementById("colorSchemeSelect"),st=document.getElementById("monoColorSwap"),rt=document.getElementById("animateToggle"),at=document.getElementById("animDurationSlider"),ct=document.getElementById("exportBtn");Q?.addEventListener("click",()=>{const o=w(b),t=w(g);o>0&&t>0&&window.renderPoints&&window.renderPoints(o,t)});tt?.addEventListener("click",()=>{const o=w(b),t=w(g);if(window.prevCoprime&&window.renderPoints){const i=window.prevCoprime(o,t);if(window.renderPoints(o,i),g){g.setAttribute("data-value",i.toString());const e=g.querySelector(".text-number-value");e&&(e.textContent=i.toString())}}});et?.addEventListener("click",()=>{const o=w(b),t=w(g);if(window.nextCoprime&&window.renderPoints){const i=window.nextCoprime(o,t);if(window.renderPoints(o,i),g){g.setAttribute("data-value",i.toString());const e=g.querySelector(".text-number-value");e&&(e.textContent=i.toString())}}});it?.addEventListener("change",o=>{const i=(o.detail?.value??15)/10;window.renderer&&(window.renderer.setPointSize(i),window.renderer.draw())});ot?.addEventListener("change",o=>{const i=o.detail?.value??12;window.setLutzC&&window.setLutzC(i)});const lt=["mono","time","lutz"];nt?.addEventListener("change",o=>{const t=o.detail,i=lt[t?.value??0];window.renderer&&(window.renderer.setColorScheme(i),i==="lutz"&&window.updateLutzColoring&&window.updateLutzColoring(),window.renderer.draw())});const dt={mint:"#80f0c0",sky:"#90d0ff",lavender:"#c5a0f5",coral:"#f0a090",peach:"#e8c4a0",yellow:"#f0e080",white:"#ffffff"};st?.addEventListener("change",o=>{const i=o.detail?.option??"mint",e=dt[i]||"#80f0c0";window.renderer&&(window.renderer.setMonoColorHex(e),window.renderer.draw())});rt?.addEventListener("change",o=>{const i=o.detail?.checked??!1;window.setAnimateEnabled&&window.setAnimateEnabled(i)});at?.addEventListener("change",o=>{const i=o.detail?.value??2;window.setAnimationDuration&&window.setAnimationDuration(i*1e3)});ct?.addEventListener("click",()=>{const o=document.getElementById("canvas"),t=w(b),i=w(g),e=document.createElement("a"),n=new Date().toISOString().replace(/[:.]/g,"-").slice(0,-5);e.download=`gp-${t}-${i}-${n}.png`,e.href=o.toDataURL("image/png"),e.click()});function T(o,t){if(!o)return;o.setAttribute("data-value",t.toString());const i=o.querySelector(".text-number-value");i&&(i.textContent=t.toString())}window.addEventListener("gp-values-changed",(o=>{const{n:t,w:i}=o.detail;T(b,t),T(g,i)}));
