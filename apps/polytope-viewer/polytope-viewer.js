...
;
    ...
    /**
     * Export polytope as OBJ file format
     * @returns {string} The polytope data in OBJ file format
     */
    exportOBJ() {
        if (!this.vertices || this.vertices.length === 0) {
            console.warn('No vertices to export');
        ...
        // Add header comment
        lines.push(`# ${this.currentPolytopeName}`);
        lines.push(`# Vertices: ${this.vertices.length}`);
        ...
        // Add faces (OBJ format: f v1 v2 v3 ...)
        // OBJ uses 1-indexed vertices, so add 1 to each index
